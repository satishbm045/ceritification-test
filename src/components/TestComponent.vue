    ...
    <div class="qn-container">
      ...
      >
        <div class="data" v-if="viewQuestion == index">
          <div class="qn-heading">
            Question {{ index + 1 }} of {{ questionSetData.details.length }}:
          </div>
          <div class="question">
          ...
          <div class="option-list">
            ...
            <div
              ...
              v-bind:key="index"
              v-on:change="optionChange(eachQuestionData)"
            >
              <input
                class="input"
                type="radio"
          ...
          <div class="Btn">
            <div
              class="submitBtn back"
              v-if="index > 0"
              v-on:click="setQuestionView(index - 1)"
            >
              Back
            </div>
            <div
              class="submitBtn next"
              v-if="index < questionSetData.details.length - 1"
              v-on:click="setQuestionView(index + 1)"
            >
              Next
            </div>
